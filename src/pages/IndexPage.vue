<template>
  <q-page class="c-page">
    <div class="c-container">
      ...
      <p class="text-h3" style="color: #e6e1e5;">Upcomings events:</p>
      <q-carousel
        v-model="slide"
      ...
      >
        <q-carousel-slide name="slide_1" class="column no-wrap ">
          <div class="row">
            <div class="col-6">
              <q-card class="c-card" style="background: rgba(178,91,43,0.9) !important;">
                <q-card-section>
      ...
      <div class="row justify-center">
        <p class="text-h4 text-weight-bolder" style="color: #e6e1e5;">To participate in our projects, leave the following details:</p>
    ...
    <q-stepper
    style="width: 100%;background:#26232a ;height: 240px"
      v-model="step"
      ref="stepper"
      done-color="red-4"
